...
public class FastHash{
   ...
   public static long fnb64(long v) {
      return (-5808582161921358473L + v) * 1099511628211L;
   }
   
   public static long fnb64(MemDataIO data, long off, int len) {
      long end = len;
   ...
   public static long fnb64(MemIO data, long off, int len) {
      long end = len;
      long h = (0xcbf29ce484222325L ^ end) * 1099511628211L;
      while(end >= 8) {
   ...
   public static long fnb64(MemDataArray data) {
      return fnb64(data, 0, (int)data.size());
   }
}
